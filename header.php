...
<body <?php body_class(); ?>>
  ...
  <div id="evan-header" >
    <h1 id="main-heading" class="display-1">Welcome</h1>
  </div>
...
<div id="page" class="hfeed site">
    ...
    <div class="wrapper-fluid wrapper-navbar" id="wrapper-navbar">
        ...
        <nav id="primary-nav" class="navbar navbar-dark bg-inverse site-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
